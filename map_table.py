...
def temp_act():
    ...
    df_temp_act = pd.read_csv('tempactinput.csv', usecols = ['Organization Name (English)', 'Organization Name (Chinese)', 'Organization Origin', 'Chinese Partner Unit (CPU) (English)', 'CPU (Chinese)', 'Field of Work', 'Activity Name (English)', 'Activity Name (Chinese)', 'Activity Location (English)', 'Activity Location (Chinese)', 'Start Date', 'End Date', 'CPU Type', 'CPU Professional Supervisory Unit (English)', 'CPU Professional Supervisory Unit (Chinese)'])


    #reorders the columns
    columnsTitles = ['Organization Name (English)', 'Organization Name (Chinese)', 'Organization Origin', 'Activity Name (English)', 'Activity Name (Chinese)', 'Activity Location (English)', 'Activity Location (Chinese)', 'Field of Work', 'Start Date', 'End Date', 'Chinese Partner Unit (CPU) (English)', 'CPU (Chinese)', 'CPU Type', 'CPU Professional Supervisory Unit (English)', 'CPU Professional Supervisory Unit (Chinese)']
    ...
    def temp_act_shuffle():
        ...
        fixed_table_2 = fixed_table_1a.replace('<th>Organization Name (English)</th>', '<th style="width:9%">Organization Name (English)</th>')
        fixed_table_3 = fixed_table_2.replace('<th>Organization Name (Chinese)</th>', '<th style="width:9%">Organization Name (Chinese)</th>')
        fixed_table_4 = fixed_table_3.replace('<th>Organization Origin</th>', '<th style="width:9%">Organization Origin</th>')
        fixed_table_5 = fixed_table_4.replace('<th>Chinese Partner Unit (English)</th>', '<th style="width:9%">Chinese Partner Unit (English)</th>')
        fixed_table_6 = fixed_table_5.replace('<th>Chinese Partner Unit (Chinese)</th>', '<th style="width:9%">Chinese Partner Unit (Chinese)</th>')
        fixed_table_7 = fixed_table_6.replace('<th>Activity Name (English)</th>', '<th style="width:9%">Activity Name (English)</th>')
        fixed_table_8 = fixed_table_7.replace('<th>Activity Name (Chinese)</th>', '<th style="width:9%">Activity Name (Chinese)</th>')
        fixed_table_9 = fixed_table_8.replace('<th>Activity Location (English)</th>', '<th style="width:9%">Activity Location (English)</th>')
        fixed_table_10 = fixed_table_9.replace('<th>Activity Location (Chinese)</th>', '<th style="width:9%">Activity Location (Chinese)</th>')
        fixed_table_11 = fixed_table_10.replace('<th>Start Date</th>', '<th style="width:5%">Start Date</th>')
        fixed_table_11a = fixed_table_11.replace('<th>Field of Work</th>', '<th style="width:9%">Field of Work</th>')
        fixed_table_12 = fixed_table_11a.replace('<th>End Date</th>', '<th style="width:5%">End Date</th>')
